  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity style={styles.button('#cddcee')} onPress={() => console.log('Button Pressed!')}>
          <Text style={styles.buttonText}>מערכת שעות</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button('#e3f3f4')} onPress={() => console.log('Button Pressed!')}>
          <Text style={styles.buttonText}>ניהול עובדים</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button('#e5d2e6')} onPress={() => console.log('Button Pressed!')}>
